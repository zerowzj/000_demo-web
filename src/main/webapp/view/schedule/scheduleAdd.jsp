...
<div class="div_head">
            <span>
                <span style="float:left">当前位置是：作业管理 => 作业列表 => 添加调度</span>
            </span>
</div>
<div></div>

<div style="font-size: 13px;margin: 10px 5px">
    <form id="_form" action="/schedule/add" method="post">
        ...
        <table border="1" width="100%" class="table_a">
            ...
            <tr>
                ...
                <td><input type="text" name="jsCronExp" datatype="*" nullmsg="请输入表达式！"/></td>
            </tr>
            <tr>
                <td>描述</td>
                <td>
                    <textarea name="jsDesc" cols="40" rows="10"></textarea>
                </td>
            </tr>
